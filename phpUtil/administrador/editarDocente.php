...
?>
<div id="editarDocente" class="modal-body" style="height:410px;">
	...
	<br>
	<br>
	<text style="font-weight:500; margin-right:95px;">UTC: </text><select id="editarDocente_utc" onchange="atualizarAreasEditar()" style="width:115px;">
	<?php
	...
	<br>
	<br>
	<text style="font-weight:500; margin-right:73px;">Admin: </text><input type="checkbox" <?php if($is_admin == 1){ ?> checked="true" <?php } ?> id="editarDocente_admin" style="margin-left:5px;">
	<br>
	<br>
	<text style="font-weight:500; margin-right:59px;">Horários: </text><input type="checkbox" <?php if($perm_horarios == 1){ ?> checked="true" <?php } ?> id="editarDocente_horarios" style="margin-left:5px;">
</div>
<div class="modal-footer">
<?php if($id_utilizador != $id_docente){ ?>
	<a class="btn btn-danger" href="javascript:void(0)" onclick="removerDocente(<?php echo $id_docente; ?>)" style="width:125px; height:45px; border-radius:25px; margin-right:51px;"><i class="material-icons" style="margin-top:3px; float:left;">person_remove</i><text style="float:left; margin-left:10px; margin-top:3px;"><b>Eliminar</b></text></a>
	<?php } ?>
    <button type="button" onclick="atualizarDocente(<?php echo $id_docente; ?>,'<?php echo $login_docente; ?>','<?php echo $password_docente; ?>','<?php echo $nome_docente; ?>',<?php echo $id_utc; ?>,<?php echo $id_area; ?>,<?php echo $id_funcao; ?>,<?php echo $is_admin; ?>,<?php echo $perm_horarios; ?>)" class="btn btn-light btn-lg" style="border-radius:50px;">
        <b>Atualizar</b>
    </button>
</div>