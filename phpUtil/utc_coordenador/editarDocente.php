...
?>
<div id="editarDocente" class="modal-body" style="height:330px;">
	...
	<?php if((($id_utilizador == $id_coordenador) || ($id_funcao == 6)) && ($id_docente != $id_utilizador)){ ?>
		<a class="btn btn-danger" href="javascript:void(0)" onclick="removerDocente(<?php echo $id_docente; ?>)" style="width:125px; height:45px; border-radius:25px; margin-top:45px;"><i class="material-icons" style="margin-top:3px; float:left;">person_remove</i><text style="float:left; margin-left:10px; margin-top:3px;"><b>Eliminar</b></text></a>
