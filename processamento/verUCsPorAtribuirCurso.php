...
include('../bd_final.php');
	...
	if(isset($_POST["id_curso"])){
		...
		$statement = mysqli_prepare($conn, "SELECT id_disciplina, abreviacao_uc, ano, semestre FROM disciplina WHERE id_curso = $id_curso AND semestre = 1 ORDER BY id_curso, id_disciplina;");
		$statement->execute();
