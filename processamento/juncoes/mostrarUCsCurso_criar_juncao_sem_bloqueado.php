...
include('../../bd.h');
	...
	if(isset($_POST["id_curso"]) && isset($_POST["semestre_bloqueado"])){
		
		$id_curso = $_POST["id_curso"];
		$semestre_bloqueado = $_POST["semestre_bloqueado"];
		...
		if(!isset($_POST["array_turmas_temp"])){
			...
			$statement = mysqli_prepare($conn, "SELECT id_disciplina, nome_uc, abreviacao_uc, ano, semestre FROM disciplina WHERE id_curso = $id_curso AND semestre != $semestre_bloqueado ORDER BY nome_uc;");
			$statement->execute();
