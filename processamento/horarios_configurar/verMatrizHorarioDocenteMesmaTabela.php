...
include('../../bd_final.php');
	...
	if(isset($_POST['semestre_atual']) && isset($_POST['numero_horas']) && (isset($_POST['id_docente'])) && (isset($_POST['id_turma'])) && (isset($_POST['id_juncao'])) && (isset($_POST['id_componente']))){	
		...
		$statement = mysqli_prepare($conn, "SELECT dia_semana, hora_inicio, id_sala FROM horario WHERE id_horario = $id_horario_a_arrastar;");
		$statement->execute();
		$resultado = $statement->get_result();
		$linha = mysqli_fetch_assoc($resultado);
