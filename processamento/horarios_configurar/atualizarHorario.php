...
include('../../bd_final.php');
	...
	if(isset($_POST['dia']) && (isset($_POST['hora'])) && (isset($_POST['numero_horas'])) && (isset($_POST['id_componente'])) && (isset($_POST['id_docente'])) && (isset($_POST['id_turma'])) && (isset($_POST['id_juncao']))){	
		...
		$statement1 = mysqli_prepare($conn, "UPDATE horario SET dia_semana = '$dia_semana' WHERE id_horario = $id_horario;");
		$statement1->execute();
		
		$statement2 = mysqli_prepare($conn, "UPDATE horario SET hora_inicio = '$hora_inicio' WHERE id_horario = $id_horario;");
		$statement2->execute();
		
		$statement3 = mysqli_prepare($conn, "UPDATE horario SET hora_fim = '$hora_fim' WHERE id_horario = $id_horario;");
		$statement3->execute();
