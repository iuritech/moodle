...
include('../../bd_final.php');
	...
	if(isset($_POST['id_utc']) && (isset($_POST['semestre_atual'])) && (isset($_POST['id_sala']))){	
		...
		while($counter_dia_semana < sizeof($array_dias_semana)){
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '08:30:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					...
					$statement2 = mysqli_prepare($conn, "SELECT a.*, t.semestre, c.id_curso FROM aula a INNER JOIN turma t ON a.id_turma = t.id_turma INNER JOIN curso c ON t.id_curso = c.id_curso WHERE a.id_docente IS NOT NULL AND a.id_horario = $id_horario;");
					$statement2->execute();
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '09:00:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '09:30:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '10:00:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '10:30:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '11:00:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '11:30:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '12:00:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '12:30:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '13:00:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '13:30:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
...
$id_juncao = 0;
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '14:00:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '14:30:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '15:00:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '15:30:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '16:00:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '16:30:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '17:00:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '17:30:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '18:00:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '18:30:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
			...
			$linha = mysqli_fetch_assoc($resultado);
				...
				if($tem_aula == 0){
					...
					$statement1 = mysqli_prepare($conn, "SELECT id_horario, hora_inicio FROM horario WHERE dia_semana = '$dia_semana' AND hora_inicio = '19:30:00' AND id_sala = $id_sala AND semestre = $semestre_atual;");
					$statement1->execute();
					$resultado1 = $statement1->get_result();
					$linha1 = mysqli_fetch_assoc($resultado1);
						$id_horario = $linha1["id_horario"];
