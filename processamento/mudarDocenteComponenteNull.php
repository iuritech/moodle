...
include('../bd_final.php');
	...
	if(isset($_POST["id_componente"]) && isset($_POST["id_docente_original"])){
		...
		$linha0 = mysqli_fetch_array($resultado0);
			...
			if($numero_juncoes > 0){
				...
				while($linha1 = mysqli_fetch_array($resultado1)){
					...
					$sql = "UPDATE aula SET id_docente = NULL WHERE id_juncao = $id_juncao;";
				...
				$linha2 = mysqli_fetch_array($resultado2);
					...
					if($num_turmas_sem_juncao > 0){
						...
						while($linha3 = mysqli_fetch_array($resultado3)){
							...
							$sql2 = "UPDATE aula SET id_docente = NULL WHERE id_componente = $id_componente 
				...
				$sql = "UPDATE aula SET id_docente = NULL WHERE id_componente = $id_componente AND id_docente = $id_docente_original;";
