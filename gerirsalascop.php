...
$sql = "SELECT sala.*, utc.* 
        ...
        ORDER BY sala.bloco_sala, sala.nome_sala";
...
if (isset($_POST['add_sala'])) {
    ...
    $sql_sala = "INSERT INTO sala (nome_sala, bloco_sala) VALUES ('$nome_sala', '$bloco_sala')";
    $conn->query($sql_sala);
    ...
    header("Location: gerirSalasCOP.php");
    exit();
}
...
if (isset($_POST['edit_sala'])) {
    ...
    $sql_sala = "UPDATE sala SET nome_sala='$nome_sala', bloco_sala='$bloco_sala' WHERE id_sala=$id_sala";
    $conn->query($sql_sala);
...
<div class="container-fluid" style="padding-top:15px;">
                    ...
                    <tbody>
                        <?php foreach ($salas as $sala): ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary"  onclick="editarSala(<?= $sala['id_sala'] ?>, '<?= htmlspecialchars($sala['nome_sala']) ?>', '<?= htmlspecialchars($sala['bloco_sala']) ?>')"><i class='material-icons' style='width:15px; height:15px; line-height:13px; float:left;'>edit_note</i></a>
                ...
                <form id="salaForm" method="post" action="">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="bloco_sala" name="bloco_sala" required>
                        </div>
                        <div class="form-group">
    ...
    <script>
        ...
        function editarSala(id, nome, bloco) {
