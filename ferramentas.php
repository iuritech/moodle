...
<!--					<li id='li_ANO_2020_2021' style='width:110px;'><a href="#"> 2020/2021</a></li>
				...
				<?php if ($permAdmin) { ?>
					...
					<ul>
						<li id='li_HORARIOS_SALAS' style='width:180px;'><a href="visHorariosSala.php?sem=<?php echo $semestre_atual; ?>"><i class="material-icons" style="vertical-align:middle;">meeting_room</i> <i>Por <text style="font-weight:500;">Sala</text></i></a></li>
						<li id='li_HORARIOS_DOCENTES' style='width:180px;'><a href="visHorariosDocente.php?sem=<?php echo $semestre_atual; ?>"><i class="material-icons" style="vertical-align:middle;">contacts</i> <i>Por <text style="font-weight:500;">Docente</text></i></a></li>
						<li id='li_HORARIOS_TURMAS' style='width:180px;'><a href="visHorariosTurma.php?sem=<?php echo $semestre_atual; ?>"><i class="material-icons" style="vertical-align:middle;">people</i> <i>Por <text style="font-weight:500;">Turma</text></i></a></li>
						<li id='li_HORARIOS_CONFIGURAR' style='width:180px;'><a href="visHorarios.php?sem=<?php echo $semestre_atual; ?>"><i class="material-icons" style="vertical-align:middle;">settings</i> <i>Selecionar <text style="font-weight:500;">Horarios</text></i></a></li>
						<li id='li_HORARIOS_GERIR' style='width:180px;'><a href="gerirPref.php?sem=<?php echo $semestre_atual; ?>"><i class="material-icons" style="vertical-align:middle;">room_preferences</i> <i>Gerir Preferências <text style="font-weight:500;"></text></i></a></li>
					<li id='li_HORARIOS_IMPRIMIR' style='width:180px;'><a href="visHorariosImprimir.php?sem=<?php echo $semestre_atual; ?>"><i class="material-icons" style="vertical-align:middle;">print</i><i>Imprimir Horários <text style="font-weight:500;"></text></i></a>
    </li>
					</ul>
					</li>
				<?php } else if ($permUTC) { ?>
    ...
    <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Projecto ApoioUTC 2022</div>
                            <div>
                                &middot;
                                Em desenvolvimento
                            </div>
