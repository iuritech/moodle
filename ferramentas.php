...
<!--					<li id='li_ANO_2020_2021' style='width:110px;'><a href="#"> 2020/2021</a></li>
				...
				<?php if ($permAdmin) { ?>
					...
					<ul>
						...
						<li id='li_HORARIOS_CONFIGURAR' style='width:180px;'><a href="gerirHorarios.php?sem=<?php echo $semestre_atual; ?>"><i class="material-icons" style="vertical-align:middle;">settings</i> <i>Gerir <text style="font-weight:500;">Horarios</text></i></a></li>
