...
if(!isset($_GET["id_sala"])){
	header("Location: visHorariosSala.php");
}
...
$statement = mysqli_prepare($conn, "SELECT * FROM sala WHERE id_sala = $id_sala;");
$statement->execute();
$resultado = $statement->get_result();
$linha = mysqli_fetch_assoc($resultado);
	$nome_sala = $linha["nome_sala"];
	$bloco_sala = $linha["bloco_sala"];
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '08:30:00' AND h.semestre = $semestre;");
$statement1->execute();
...
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_08_30 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '08:30:00' AND h.semestre = $semestre;");
		$statement2->execute();
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '09:00:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_09_00 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '09:00:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '09:30:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_09_30 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '09:30:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '10:00:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_10_00 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '10:00:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '10:30:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_10_30 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '10:30:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '11:00:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_11_00 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '11:00:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '11:30:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_11_30 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '11:30:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '12:00:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_12_00 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '12:00:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '12:30:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_12_30 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '12:30:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '13:00:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_13_00 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '13:00:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '13:30:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_13_30 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '13:30:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '14:00:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_14_00 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '14:00:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '14:30:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_14_30 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '14:30:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '15:00:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_15_00 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '15:00:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '15:30:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_15_30 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '15:30:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '16:00:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_16_00 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '16:00:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '16:30:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_16_30 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '16:30:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '17:00:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_17_00 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '17:00:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '17:30:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_17_30 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '17:30:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '18:00:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_18_00 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '18:00:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '18:30:00' AND h.semestre = $semestre;");
$statement1->execute();
$resultado1 = $statement1->get_result();
$linha1 = mysqli_fetch_assoc($resultado1);
	...
	if($num_aulas_18_30 > 0){
		...
		$statement2 = mysqli_prepare($conn, "SELECT DISTINCT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.hora_inicio = '18:30:00' AND h.semestre = $semestre;");
		$statement2->execute();
		$resultado2 = $statement2->get_result();
		while($linha2 = mysqli_fetch_assoc($resultado2)){
...
<div class="container-fluid">
	<div class="card shadow mb-4">
		<div class="card-body">
			<a href="http://localhost/apoio_utc/home.php"><h6 style="margin-left:15px; margin-top:10px;">...</a> / <a href="visHorariosSala.php?sem=<?php echo $semestre; ?>"> Horários - Salas</a> / <a href="">Horários - <b><?php echo $nome_sala ?></b></a></h6>
			<h3 align="center" style="margin-left:15px; margin-top:20px; margin-bottom:30px;">Bloco <?php echo $bloco_sala; ?> - <b><?php echo $nome_sala, " (", $semestre, "ºS)"; ?></b><!--<text style="margin-left:15px; font-size:17px; margin-bottom:35px; font-weight:550;"><i>(<?php echo $semestre; ?>º Semestre)</i></text> --></h3>
			
			<?php
			/*
				$statement2 = mysqli_prepare($conn, "SELECT * FROM horario WHERE id_sala = $id_sala AND dia_semana = 'SEG' AND semestre = $semestre ORDER BY hora_inicio;");
$statement2->execute();
$resultado2 = $statement2->get_result();
while($linha2 = mysqli_fetch_assoc($resultado2)){
...
$statement2 = mysqli_prepare($conn, "SELECT * FROM horario WHERE id_sala = $id_sala AND dia_semana = 'TER' AND semestre = $semestre ORDER BY hora_inicio;");
$statement2->execute();
$resultado2 = $statement2->get_result();
while($linha2 = mysqli_fetch_assoc($resultado2)){
	$id_horario = $linha2["id_horario"];
...
$statement2 = mysqli_prepare($conn, "SELECT * FROM horario WHERE id_sala = $id_sala AND dia_semana = 'QUA' AND semestre = $semestre ORDER BY hora_inicio;");
$statement2->execute();
$resultado2 = $statement2->get_result();
while($linha2 = mysqli_fetch_assoc($resultado2)){
	$id_horario = $linha2["id_horario"];
...
$statement2 = mysqli_prepare($conn, "SELECT * FROM horario WHERE id_sala = $id_sala AND dia_semana = 'QUI' AND semestre = $semestre ORDER BY hora_inicio;");
$statement2->execute();
$resultado2 = $statement2->get_result();
while($linha2 = mysqli_fetch_assoc($resultado2)){
	$id_horario = $linha2["id_horario"];
...
$statement2 = mysqli_prepare($conn, "SELECT * FROM horario WHERE id_sala = $id_sala AND dia_semana = 'SEX' AND semestre = $semestre ORDER BY hora_inicio;");
$statement2->execute();
$resultado2 = $statement2->get_result();
while($linha2 = mysqli_fetch_assoc($resultado2)){
	$id_horario = $linha2["id_horario"];
			...
			?>
				...
				<?php
					...
					while($loop_dias_semana < sizeof($dias_semana)){
						...
						$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '08:30:00' AND h.semestre = $semestre;");
						$statement1->execute();
						$resultado1 = $statement1->get_result();
						$linha1 = mysqli_fetch_assoc($resultado1);
							...
							if($tem_aula > 0){
								$statement2 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '08:30:00' AND h.semestre = $semestre;");
								$statement2->execute();
								$resultado2 = $statement2->get_result();
								...
								if($loop_dias_semana == 4){
									...
									while($loop_turmas < sizeof($turmas)){
										...
										echo "<text style='font-weight:500;'>", $sigla_curso, $ano, "_", $abreviacao_uc, "<br>", $sigla_tipocomponente, "<br>", $sigla_completa_curso, ".", $ano, ".", $numero_turma, "<br>", $nome_docente, "</text><br>";
								...
								$statement11 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '09:00:00' AND h.semestre = $semestre;");
								$statement11->execute();
								$resultado11 = $statement11->get_result();
								$linha11 = mysqli_fetch_assoc($resultado11);
									...
									if($tem_aula_pontual == 0){
										...
										$statement12 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '09:00:00' AND h.semestre = $semestre;");
										$statement12->execute();
					...
					<?php
						...
						$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '09:30:00' AND h.semestre = $semestre;");
						$statement1->execute();
						$resultado1 = $statement1->get_result();
						$linha1 = mysqli_fetch_assoc($resultado1);
							$tem_aula = $linha1["COUNT(a.id_horario)"];
							...
							if($tem_aula > 0){
								$statement2 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '09:30:00' AND h.semestre = $semestre;");
								$statement2->execute();
								$resultado2 = $statement2->get_result();
								$linha2 = mysqli_fetch_assoc($resultado2);
									$id_horario = $linha2["id_horario"];
								...
								$statement11 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '10:00:00' AND h.semestre = $semestre;");
								$statement11->execute();
								$resultado11 = $statement11->get_result();
								$linha11 = mysqli_fetch_assoc($resultado11);
									$tem_aula_pontual = $linha11["COUNT(a.id_horario)"];
									...
									if($tem_aula_pontual == 0){
										...
										$statement12 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '10:00:00' AND h.semestre = $semestre;");
										$statement12->execute();
										$resultado12 = $statement12->get_result();
										$linha12 = mysqli_fetch_assoc($resultado12);
											$id_horario = $linha12["id_horario"];
					...
					<?php
						...
						$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '10:30:00' AND h.semestre = $semestre;");
						$statement1->execute();
						$resultado1 = $statement1->get_result();
						$linha1 = mysqli_fetch_assoc($resultado1);
							$tem_aula = $linha1["COUNT(a.id_horario)"];
							...
							if($tem_aula > 0){
								$statement2 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '10:30:00' AND h.semestre = $semestre;");
								$statement2->execute();
								$resultado2 = $statement2->get_result();
								$linha2 = mysqli_fetch_assoc($resultado2);
									$id_horario = $linha2["id_horario"];
								...
								$statement11 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '11:00:00' AND h.semestre = $semestre;");
								$statement11->execute();
								$resultado11 = $statement11->get_result();
								$linha11 = mysqli_fetch_assoc($resultado11);
									$tem_aula_pontual = $linha11["COUNT(a.id_horario)"];
									...
									if($tem_aula_pontual == 0){
										...
										$statement12 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '11:00:00' AND h.semestre = $semestre;");
										$statement12->execute();
										$resultado12 = $statement12->get_result();
										$linha12 = mysqli_fetch_assoc($resultado12);
											$id_horario = $linha12["id_horario"];
					...
					<?php
						...
						$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '11:30:00' AND h.semestre = $semestre;");
						$statement1->execute();
						$resultado1 = $statement1->get_result();
						$linha1 = mysqli_fetch_assoc($resultado1);
							$tem_aula = $linha1["COUNT(a.id_horario)"];
							...
							if($tem_aula > 0){
								$statement2 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '11:30:00' AND h.semestre = $semestre;");
								$statement2->execute();
								$resultado2 = $statement2->get_result();
								$linha2 = mysqli_fetch_assoc($resultado2);
									$id_horario = $linha2["id_horario"];
								...
								$statement11 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '12:00:00' AND h.semestre = $semestre;");
								$statement11->execute();
								$resultado11 = $statement11->get_result();
								$linha11 = mysqli_fetch_assoc($resultado11);
									$tem_aula_pontual = $linha11["COUNT(a.id_horario)"];
									...
									if($tem_aula_pontual == 0){
										...
										$statement12 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '12:00:00' AND h.semestre = $semestre;");
										$statement12->execute();
										$resultado12 = $statement12->get_result();
										$linha12 = mysqli_fetch_assoc($resultado12);
											$id_horario = $linha12["id_horario"];
					...
					<?php
						...
						$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '12:30:00' AND h.semestre = $semestre;");
						$statement1->execute();
						$resultado1 = $statement1->get_result();
						$linha1 = mysqli_fetch_assoc($resultado1);
							$tem_aula = $linha1["COUNT(a.id_horario)"];
							...
							if($tem_aula > 0){
								$statement2 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '12:30:00' AND h.semestre = $semestre;");
								$statement2->execute();
								$resultado2 = $statement2->get_result();
								$linha2 = mysqli_fetch_assoc($resultado2);
									$id_horario = $linha2["id_horario"];
								...
								$statement11 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '13:00:00' AND h.semestre = $semestre;");
								$statement11->execute();
								$resultado11 = $statement11->get_result();
								$linha11 = mysqli_fetch_assoc($resultado11);
									$tem_aula_pontual = $linha11["COUNT(a.id_horario)"];
									...
									if($tem_aula_pontual == 0){
										...
										$statement12 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '13:00:00' AND h.semestre = $semestre;");
										$statement12->execute();
										$resultado12 = $statement12->get_result();
										$linha12 = mysqli_fetch_assoc($resultado12);
											$id_horario = $linha12["id_horario"];
					...
					<?php
						...
						$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '13:30:00' AND h.semestre = $semestre;");
						$statement1->execute();
						$resultado1 = $statement1->get_result();
						$linha1 = mysqli_fetch_assoc($resultado1);
							$tem_aula = $linha1["COUNT(a.id_horario)"];
							...
							if($tem_aula > 0){
								$statement2 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '13:30:00' AND h.semestre = $semestre;");
								$statement2->execute();
								$resultado2 = $statement2->get_result();
								$linha2 = mysqli_fetch_assoc($resultado2);
									$id_horario = $linha2["id_horario"];
								...
								$statement11 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '14:00:00' AND h.semestre = $semestre;");
								$statement11->execute();
								$resultado11 = $statement11->get_result();
								$linha11 = mysqli_fetch_assoc($resultado11);
									$tem_aula_pontual = $linha11["COUNT(a.id_horario)"];
									...
									if($tem_aula_pontual == 0){
										...
										$statement12 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '14:00:00' AND h.semestre = $semestre;");
										$statement12->execute();
										$resultado12 = $statement12->get_result();
										$linha12 = mysqli_fetch_assoc($resultado12);
											$id_horario = $linha12["id_horario"];
					...
					<?php
						...
						$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '14:30:00' AND h.semestre = $semestre;");
						$statement1->execute();
						$resultado1 = $statement1->get_result();
						$linha1 = mysqli_fetch_assoc($resultado1);
							$tem_aula = $linha1["COUNT(a.id_horario)"];
							...
							if($tem_aula > 0){
								$statement2 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '14:30:00' AND h.semestre = $semestre;");
								$statement2->execute();
								$resultado2 = $statement2->get_result();
								$linha2 = mysqli_fetch_assoc($resultado2);
									$id_horario = $linha2["id_horario"];
								...
								$statement11 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '15:00:00' AND h.semestre = $semestre;");
								$statement11->execute();
								$resultado11 = $statement11->get_result();
								$linha11 = mysqli_fetch_assoc($resultado11);
									$tem_aula_pontual = $linha11["COUNT(a.id_horario)"];
									...
									if($tem_aula_pontual == 0){
										...
										$statement12 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '15:00:00' AND h.semestre = $semestre;");
										$statement12->execute();
										$resultado12 = $statement12->get_result();
										$linha12 = mysqli_fetch_assoc($resultado12);
											$id_horario = $linha12["id_horario"];
					...
					<?php
						...
						$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '15:30:00' AND h.semestre = $semestre;");
						$statement1->execute();
						$resultado1 = $statement1->get_result();
						$linha1 = mysqli_fetch_assoc($resultado1);
							$tem_aula = $linha1["COUNT(a.id_horario)"];
							...
							if($tem_aula > 0){
								$statement2 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '15:30:00' AND h.semestre = $semestre;");
								$statement2->execute();
								$resultado2 = $statement2->get_result();
								$linha2 = mysqli_fetch_assoc($resultado2);
									$id_horario = $linha2["id_horario"];
								...
								$statement11 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '16:00:00' AND h.semestre = $semestre;");
								$statement11->execute();
								$resultado11 = $statement11->get_result();
								$linha11 = mysqli_fetch_assoc($resultado11);
									$tem_aula_pontual = $linha11["COUNT(a.id_horario)"];
									...
									if($tem_aula_pontual == 0){
										...
										$statement12 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '16:00:00' AND h.semestre = $semestre;");
										$statement12->execute();
										$resultado12 = $statement12->get_result();
										$linha12 = mysqli_fetch_assoc($resultado12);
											$id_horario = $linha12["id_horario"];
				...
				<?php
						...
						$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '16:30:00' AND h.semestre = $semestre;");
						$statement1->execute();
						$resultado1 = $statement1->get_result();
						$linha1 = mysqli_fetch_assoc($resultado1);
							$tem_aula = $linha1["COUNT(a.id_horario)"];
							...
							if($tem_aula > 0){
								$statement2 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '16:30:00' AND h.semestre = $semestre;");
								$statement2->execute();
								$resultado2 = $statement2->get_result();
								$linha2 = mysqli_fetch_assoc($resultado2);
									$id_horario = $linha2["id_horario"];
								...
								$statement11 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '17:00:00' AND h.semestre = $semestre;");
								$statement11->execute();
								$resultado11 = $statement11->get_result();
								$linha11 = mysqli_fetch_assoc($resultado11);
									$tem_aula_pontual = $linha11["COUNT(a.id_horario)"];
									...
									if($tem_aula_pontual == 0){
										...
										$statement12 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '17:00:00' AND h.semestre = $semestre;");
										$statement12->execute();
										$resultado12 = $statement12->get_result();
										$linha12 = mysqli_fetch_assoc($resultado12);
											$id_horario = $linha12["id_horario"];
					...
					<?php
						...
						$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '17:30:00' AND h.semestre = $semestre;");
						$statement1->execute();
						$resultado1 = $statement1->get_result();
						$linha1 = mysqli_fetch_assoc($resultado1);
							$tem_aula = $linha1["COUNT(a.id_horario)"];
							...
							if($tem_aula > 0){
								$statement2 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '17:30:00' AND h.semestre = $semestre;");
								$statement2->execute();
								$resultado2 = $statement2->get_result();
								$linha2 = mysqli_fetch_assoc($resultado2);
									$id_horario = $linha2["id_horario"];
								...
								$statement11 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '18:00:00' AND h.semestre = $semestre;");
								$statement11->execute();
								$resultado11 = $statement11->get_result();
								$linha11 = mysqli_fetch_assoc($resultado11);
									$tem_aula_pontual = $linha11["COUNT(a.id_horario)"];
									...
									if($tem_aula_pontual == 0){
										...
										$statement12 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '18:00:00' AND h.semestre = $semestre;");
										$statement12->execute();
										$resultado12 = $statement12->get_result();
										$linha12 = mysqli_fetch_assoc($resultado12);
											$id_horario = $linha12["id_horario"];
					...
					<?php
							...
							$statement1 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '18:30:00' AND h.semestre = $semestre;");
						$statement1->execute();
						$resultado1 = $statement1->get_result();
						$linha1 = mysqli_fetch_assoc($resultado1);
							$tem_aula = $linha1["COUNT(a.id_horario)"];
							...
							if($tem_aula > 0){
								$statement2 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '18:30:00' AND h.semestre = $semestre;");
								$statement2->execute();
								$resultado2 = $statement2->get_result();
								$linha2 = mysqli_fetch_assoc($resultado2);
									$id_horario = $linha2["id_horario"];
								...
								$statement11 = mysqli_prepare($conn, "SELECT COUNT(a.id_horario) FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '19:00:00' AND h.semestre = $semestre;");
								$statement11->execute();
								$resultado11 = $statement11->get_result();
								$linha11 = mysqli_fetch_assoc($resultado11);
									$tem_aula_pontual = $linha11["COUNT(a.id_horario)"];
									...
									if($tem_aula_pontual == 0){
										...
										$statement12 = mysqli_prepare($conn, "SELECT a.id_horario FROM aula a INNER JOIN horario h ON a.id_horario = h.id_horario WHERE h.id_sala = $id_sala AND h.dia_semana = '$dia_semana' AND h.hora_inicio = '19:00:00' AND h.semestre = $semestre;");
										$statement12->execute();
										$resultado12 = $statement12->get_result();
										$linha12 = mysqli_fetch_assoc($resultado12);
											$id_horario = $linha12["id_horario"];
